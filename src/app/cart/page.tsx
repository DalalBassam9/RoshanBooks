                        ...
                        <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
                            ...
                            <div className="mt-5 grid grid-flow-row-dense grid-cols-1 gap-3">
                                <div className='flex items-center justify-between gap-x-6'>
                                    ...
                                    <button className="w-full rounded-full mx-2 bg-beige px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-beige focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-beige" onClick={() => router.push('/checkout')} >Checkout</button>
