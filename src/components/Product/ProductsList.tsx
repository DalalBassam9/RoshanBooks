...
const filters = [
    {
        ...
        name: 'Category',
        options: [
            { value: 'new-arrivals', label: 'Arabic books', checked: false },
            { value: 'sale', label: 'English Books', checked: false },
            { value: 'travel', label: 'Book accessories', checked: true },
        ],
    },
    {
        id: 'Product status',
        name: 'Product status',
        options: [
            { value: 'stock', label: 'stock', checked: false },
